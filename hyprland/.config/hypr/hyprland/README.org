...
#+begin_src conf
  ...
  bind = $mainMod, T, exec, [float] emacsclient -cF "((visibility . nil))" -e "(emacs-counsel-launcher)"
...
#+begin_src conf
  bind = $mainMod, W, exec, ~/.config/swww/swww.sh
...
#+begin_src conf
  ...
  # Screenshots
  bind = $mainMod, S, exec, slurp | grim -g - - | tee ~/Pictures/Screenshots/$(date +%s).png | wl-copy
  #bind = , , exec, slurp | grim -g - - | tee ~/Pictures/$(date +%s).png | wl-copy
